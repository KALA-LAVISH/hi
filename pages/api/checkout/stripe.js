      ...
      try {
        ...
        const price =
          req.body.type === "custom"
            ? req.body.customRing?.totalPrice
            : body.items.reduce(
        ...
        const intentObject = {
          ...
          description: process.env.NEXT_PUBLIC_STRIPE_PAYMENT_DESCRIPTION,
          shipping: {
            name: body.shippingInfo?.fullName,
            address: {
              line1: body.shippingInfo?.house,
