                      ...
                      {orderData.type === "custom" ? (
                        <>
                          <tr>
                            <th scope="row">1</th>
                            <td>
                              Custom ring with {orderData.products[0]?.name}
                            </td>
                            <td>
                              <ImageLoader
                                src={orderData.products[0]?.image[0]?.url}
                                width={50}
                                height={50}
                            ...
                            <td>N/A</td>
                            <td>
                              {orderData.products[0]?.combination &&
                                orderData.products[0]?.combination.map(
                                  (x, i) => (
                                    <div
                                      key={i + x.name}
                                    >{`${x.title}: ${x.name}`}</div>
                            ...
                            <td>
                              {currencySymbol +
                                orderData.products[0]?.totalPrice}
                            </td>
                          </tr>
                        </>
                      ) : (
                        <>
                          {orderData.products.map((product, idx) => (
                            <tr key={idx}>
                              ...
                              <td>
                                {product.variant &&
                                  Object.keys(product.variant).map(
                                    (x, idx) =>
                                      x !== "id" && (
                                        <span
                                          key={idx}
                                          className="d-block"
                                        >{`${x}: ${product.variant[x]}`}</span>
                                      )
                                  )}
                              </td>
                              <td>{product.qty}</td>
